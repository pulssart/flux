...
const DICT: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    settingsTabStyle: "Style d'écriture",
    theme: "Thème",
    light: "Light",
    dark: "Dark",
    system: "System",
    ...
    onboardingPersonaTitle: "Choisissez votre profil",
    onboardingPersonaDesc: "Sélectionnez un profil pour démarrer avec une sélection de flux RSS pertinents (optionnel)",
    onboardingPersonaSkip: "Je préfère partir de zéro",
    onboardingPersonaSelect: "Choisir ce profil",
    ...
    writingStyleRefLabel: "Référence stylistique",
    writingStyleRefHelp: "Collez ici un ou plusieurs exemples de texte dont GPT devra s'inspirer (ne sera pas inclus tel quel dans les posts).",
  ...
  en: {
    ...
    settingsTabStyle: "Writing style",
    theme: "Theme",
    light: "Light",
    dark: "Dark",
    system: "System",
    ...
    onboardingPersonaTitle: "Choose your profile",
    onboardingPersonaDesc: "Select a profile to start with a curated selection of relevant RSS feeds (optional)",
    onboardingPersonaSkip: "I prefer to start from scratch",
    onboardingPersonaSelect: "Choose this profile",
    ...
    writingStyleRefLabel: "Style reference",
    writingStyleRefHelp: "Paste one or more sample texts that GPT should mimic (will not be quoted verbatim in posts).",
